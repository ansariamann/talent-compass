...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        sans: ['-apple-system', 'BlinkMacSystemFont', 'SF Pro Text', 'SF Pro Display', 'Helvetica Neue', 'Arial', 'system-ui', 'sans-serif'],
      ...
      colors: {
        ...
        // Keep vibrant keys so existing components referencing them don't break
        vibrant: {
